...
export const createRepository = async (repo: RepositoryItem): Promise<void> => {
    try {
        ...
        console.log("Repositorio ingresado y creado con éxito", response.data);
...
export const getUserInfo = async (): Promise<UserInfo | null> => {
    try {
        ...
        const userNotFound: UserInfo = {
            ...
            avatar_url: 'https://cdn-icons-png.freepik.com/256/12391/12391316.png?semt=ais_white_label',
        }
        return userNotFound;
    }
